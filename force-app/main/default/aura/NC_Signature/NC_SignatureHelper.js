({
   ...
   //     console.log("application id in edit value " + component.get("v.applicationId"));
     ...
     // console.log('dataUrl:=' + dataUrl);
        ...
        action.setCallback(this, function(res) {
            ...
            if (state === "SUCCESS") {
                ...
                //component.find("overlayLib").notifyClose();
                var appEvent = $A.get("e.c:NC_SignEvent");
    ...
    clearToastMessage: function(component, event) {
        component.set("v.errorMessage","Success Signature Cleared Successfully!");
        window.setTimeout(
    ...
    uploadSign: function(component, event, helper, contentDocumentId) {
        component.set("v.spinner", true);
        var action = component.get("c.uploadSign");
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                appEvent.fire();
                helper.showToast("Success!", "Signature saved under attachments in related section successfully!", "success");
                component.set("v.spinner", false);
            } else if (state === "ERROR") {
